    ...
    <tbody>
      <?php foreach ($datos['beca']as $beca): ?>
        ...
        <?php foreach ($datos['madrina']as $madrina): ?>
          ...
          <?php endif?>
        <td class="">
        <a class="w-sm-100 btn btn-outline-success btn-lg" href="<?php echo RUTA_URL?>/becas/ver_beca/<?php echo $beca->idBeca ?>"><i class="bi bi-pencil-square"></i></a>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form method="post" id="formCerrarAccion" action="<?php ECHO RUTA_URL ?>/becas/eliminar_beca/<?php echo $beca->idBeca ?>">
