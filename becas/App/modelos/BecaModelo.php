...
return $this->db->registro();
        ...
        public function addBeca($datos){
            ...
            print_r($datos);
            // $this->db->query("INSERT INTO Beca (Importe, Fecha_Fin, Fecha_Inicio, Observaciones ,Alumno_idPersona, idCentro, Fecha_AlumnoBeca, NotaMedia_Alumno, idTipoBeca,Madrina_idPersona) 
            //             VALUES (:importe_be, :fechaFin_be, :fechaInicio_be, :obs_be, :alumno_be, :centro_be, now(),:notaMedia ,:tipo_be, 1");
            ...
            $this->db->query("INSERT INTO Movimiento (Procedencia, Accion, Fecha_Movimento, Cantidad, idTipoMovimento, idBeca) VALUES ('Alcañiz', 'Beca', NOW(), :importe_be, '2', :idBeca)");
