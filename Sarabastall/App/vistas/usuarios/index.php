...
<?php require_once RUTA_APP.'/vistas/inc/header_inicio_sesion.php'; //print_r($datos["usuariosActivos"]);?>
  ...
  <a class="btn btn-primary mt-3 mb-3"  onclick="ordenarTipo()">Ordenar por Tipo</a>
    ...
    <!-- <?php //foreach ($datos['usuariosActivos'] as $user) {?>
        ...
        <li id="nombreyrolUser" class="list-group-item mb-2"><img class="rounded" style="width:30px;" src="img/usuario.png"> <?php //echo $user->Nombre?>: <?php //echo $user->NombreRol?> 
            <div class="mt-1 mb-1">
...
<script>
        ...
        function filtroOrden(datosTabla){
    ...
    function ordenarTipo(){
        ...
        var datosTabla=<?php echo json_encode($datos['usuariosActivos'])?>;
