...
<div class="container mt-3">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="<?php echo RUTA_URL?>">Prestamos</a></li>
  ...
  <h1 class="text-center">Prestamo: <?php echo $datos['prestamo']->Titulo?></h1>
      ...
      <div class='row'>
        ...
        <div class='col-md-7'>
          ...
          <form method="post" action="<?php echo RUTA_URL?>/prestamos/add_accion">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form method="post" id="formCerrarAccion" action="<?php ECHO RUTA_URL ?>/prestamos/cerrar_prestamo">
