...
<div class="container col-12 mt-3">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li id="lipan" class="breadcrumb-item active" aria-current="page">Prestamos</li>
    </ol>
  </nav>
    ...
    <tbody>
      ...
      <tr>
        ...
        <?php  echo ($prestamo->Persona)?>
           ...
           <a class="w-25 btn btn-outline-primary btn-lg"  href="<?php echo RUTA_URL?>/prestamos/ver_prestamo/<?php echo $prestamo->idPrestamo ?>"><i class="bi-eye"></i>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form method="post" id="formCerrarAccion" action="<?php ECHO RUTA_URL ?>/prestamos/eliminar_prestamo/<?php echo $prestamo->idPrestamo ?>">
