  ...
  <div class="fuente1 container" id="container">
  ...
  <form class="d-flex mb-3" role="search">
      <input class="form-control me-2" type="search" placeholder="Buscar usuario" id="q" aria-label="Search">
    ...
    <?php foreach ($datos['usuariosActivos'] as $user) {?>
        ...
        <li class="shadow list-group-item mb-2" id="carta"><img class="rounded" style="width:30px;" src="img/usuario.png"> <?php echo $user->Nombre?>: <?php echo $user->NombreRol?> 
            <div class="mt-1 mb-1">
...
<script>
  function searchUsuarios(){
			...
			datos=<?php echo json_encode($datos['usuariosActivos']) ?>
