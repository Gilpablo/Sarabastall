...
<div class="container mt-3">
  ...
  <nav aria-label="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="<?php ECHO RUTA_URL ?>/beca/ver_becas/<?php echo $datos["becas"]->idTipoBeca?>">Ver Becas</a></li>
  ...
  <?php endforeach?>
      ...
      <div class="col-5">
        <a class="w-100 btn btn-danger btn-lg" href="<?php ECHO RUTA_URL ?>/beca/ver_becas/<?php echo $datos["becas"]->idTipoBeca?>">Cancelar</a>
      </div>
