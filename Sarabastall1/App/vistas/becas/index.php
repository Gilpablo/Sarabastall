<?php require_once RUTA_APP.'/vistas/inc/header_inicio_sesion.php';?>
  ...
  <a class="btn btn-primary mt-3  "  href="<?php echo RUTA_URL?>/beca/add_becas">Añadir Beca</a>
    <!-- <div class="row d-flex justify-content-center text-center mx-0 mt-3">
        <div class="col-12">
            <h1>Becas</h1>
        </div>btn btn-primary col-12 col-sm-8 col-md-8 col-lg-2 col-xl-1
    </div>        
    <div class="mb-3 d-grid gap-2 d-md-flex justify-content-md">
    ...
    <?php foreach ($datos["becas"] as $tipobeca): ?>
      ...
      <div class="row bg-light mt-3 border border-dark ms-1">
