            ...
            <div class="container">
                <div class="modal-dialog w-100">
                    <div class="modal-content w-100 px-0 mx-0">
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?php echo RUTA_URL ?>/archivos/add_archivos">
                    ...
                    <div class="modal-content w-100 px-0 mx-0">
                        ...
                        <form method="post">
                            <div class="modal-body">
                                ...
                                <a href=>
                                    <input type="submit" class="btn btn-primary" value="Descargar" formaction="<?php echo RUTA_URL?>/archivos/get_archivo">
                                </a>
                            </div>
                            <div class="modal-footer">

                                <input type="submit" class="btn btn-danger" id="buttonDel" name="borrar" value="Borrar" onclick="confirmarDel()" formaction="<?php echo RUTA_URL?>/archivos/del_archivo">
                                <input type="submit" class="btn btn-success" name="modificar" value="Modificar Archivo" formaction="<?php echo RUTA_URL?>/archivos/mod_archivo">
