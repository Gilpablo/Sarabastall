                    ...
                    <div class="modal-content w-100 px-0 mx-0">
                        ...
                        <form method="post">
                            <div class="modal-body">
                                ...
                                <?php foreach ($datos['materiales'] as $material): ?>
                                <a type="submit" class="btn btn-primary" href="<?php echo RUTA_URL?>/archivos_cliente/<?php echo $material->Nombre;?>" download="<?php echo $material->Nombre;?>" target="_blank">Descargar
                                <?php endforeach ?>   
                                </a>
                            </div>
                            <div class="modal-footer">
