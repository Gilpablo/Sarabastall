...
<div class="container mt-3">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Añadir microcredito</li>
    </ol>
  </nav>
    
  <div class="row d-flex justify-content-center text-center mx-0 mt-3">
      <div class="col-12">
      <h1>Añadir Microcredito</h1>
      </div>
  </div> 
  ...
  <form method="post">
    <div class="row">
      ...
      <div class="mb-3 col-12">
        ...
        <input type="number" class="form-control" id="importe_pr" name="importe_pr" required pattern="[0-9]+">   
      </div>

      <div class="mb-3 col-12">
        <label for="titulo_as" class="form-label">Para persona</label>
        <input type="text" class="form-control" id="persona_pr" name="persona_pr" required>   
      </div>
