...
<div class="container mt-3">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="<?php echo RUTA_URL?>/prestamo">microcreditos</a></li>
      <li class="breadcrumb-item active" aria-current="page">Ver microcredito</li>
    </ol>
  </nav>
  
  <h1 class="text-center">Microcredito: <?php echo $datos['prestamo']->Titulo?></h1>
    ...
    <div class='shadow card1 col-md-5 bg-light mt-2'>
      <h2 class="mt-2">Pagos realizados:</h2>
        
        <?php foreach ($datos["prestamo"]->acciones as $accion): ?> 
          
          <div class="card-header"> <?php echo $accion->Fecha_Abonado?></div>
          <div class="card-body">
            <h5 class="card-title1">  <?php echo $accion->Cantidad?>€</h5>
          </div>
        <?php endforeach ?>
    </div> 
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalCerrarAccionLabel">
          ¿Estas seguro que quieres cerrar el microcredito?
        </h5>
      </div>
