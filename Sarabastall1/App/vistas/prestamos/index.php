  ...
  <thead>
    ...
    <tbody id="tbody" class="bg-light">
      ...
      <tr>
           ...
           <a class="w-sm-100 btn btn-outline-success btn-lg"  href="<?php echo RUTA_URL?>/prestamo/ver_prestamo/<?php echo $prestamo->idPrestamo ?>">
            <i class="bi-eye"></i>
           </a>
              ...
              <button type="button" onclick="validar_borrar(<?php echo $prestamo->idPrestamo ?>)" 
                data-bs-toggle="modal" data-bs-target="#modalCerrarAccion" class="w-sm-25 btn btn-outline-danger btn-lg">
                <i class="bi-trash"></i>
              </button>
