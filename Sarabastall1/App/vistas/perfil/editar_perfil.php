...
<div class="container mt-3">
  ...
  <i class="bi bi-person-circle"></I></h1>
      ...
      <div class='row'>
        ...
        <div class="shadow-lg container card1 col-12">

            <form class="my-3" name="formulario" method='post' class='mb-5' onsubmit="return validarFormulario()">
                <div class="row">
                ...
                <div class="mb-3 col-4">
                    ...
                    <input  type="password"  class="form-control" id="clave" name="clave" value="<?php echo $datos['usuario']->Clave?>" required>   
                            ...
                            <div class="mb-3 col-4">
                                ...
                                <input  type="text"  class="form-control" id="telefono" name="telefono" value="<?php echo $datos['usuario']->Telefono?>" onkeyup="validarTelefono(this)" required>   
                            </div>
                            <div class="mb-3 col-4">
                                <label for="nombre_as" class="form-label">Correo</label>
                                <input  type="email"  class="form-control" id="correo" name="correo" value="<?php echo $datos['usuario']->Correo?>" onkeyup="validarCorreo(this)" required>   
                            </div>
